...
- **User** — Read-only preview of the exact default core context returned by `get_core_memories`. Selecting an agent shows the agent-scoped view an assistant receives by default; detailed browsing/editing remains in the Memories tab
