...
function memoriesTab() {
  return {
    ...
    /** Current sort key for the memory list */
    sortBy: 'newest',
    ...
    /**
     * Return a sorted copy of this.memories based on this.sortBy.
     * @returns {Array}
     */
    get sortedMemories() {
      ...
      switch (this.sortBy) {
        ...
        case 'type':
          return arr.sort((a, b) =>
            (a.metadata?.memory_type || '').localeCompare(b.metadata?.memory_type || '')
          );
        case 'alpha':
          return arr.sort((a, b) =>
